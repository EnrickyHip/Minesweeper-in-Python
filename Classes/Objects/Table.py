...
class Table:
    def __init__(self, screen: pygame.Surface):
        ...
        self.squares = Matrix.create(24, 15, lambda x, y: Square(
            self.screen, self, x, y))  # creates a multidimensional array
        self.squares_sprites = pygame.sprite.Group()

        self.score = Text(self.screen, str(self.flags_available),
                          'Arial', 34, (230, 0, 0), (398, 47))
    ...
    def generate_squares(self):
        ...
        Matrix.for_each(
            self.squares, lambda square: self.squares_sprites.add(square))
    ...
    def generate_bombs(self):
        ...
        while i < self.bombs_number:
            ...
            # to ensure the code just mark as bomb the squares that aren't are yet.
    ...
    def get_neighbors(self):
        Matrix.for_each(
            self.squares, lambda square: square.get_neighbors_bombs())
    ...
    def win(self):
        ...
        win_text_left = Text(self.screen, "You Won!",
                             'Arial', 34, (255, 255, 255), (160, 55))
        win_text_right = Text(self.screen, "You Won!",
                              'Arial', 34, (255, 255, 255), (535, 55))
    ...
    def actions(self, action, event):
        ...
        squares = pygame.sprite.spritecollide(
            point, self.squares_sprites, False)
